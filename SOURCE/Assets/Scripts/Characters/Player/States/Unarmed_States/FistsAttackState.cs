...
public class FistsAttackState : SKMecanimState<PlayerCharacterController>  
{
	...
	private BaseWeapon unarmedFists;
	...
	public override void begin ()
	{
		...
		if (unarmedFists == null)
			unarmedFists = context.attackController.GetWeapon (WEAPON_NAME.FIST_PUNCH);

		context.attackController.EquipWeapon (unarmedFists.weaponName);
