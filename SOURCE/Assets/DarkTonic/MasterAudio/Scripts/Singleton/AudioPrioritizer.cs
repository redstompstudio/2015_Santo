...
namespace DarkTonic.MasterAudio {
    ...
    public static class AudioPrioritizer {
        ...
        public static void Set3DPriority(AudioSource audio, bool useClipAgePriority) {
            ...
            var distanceToListener = Vector3.Distance(audio.transform.position,
                MasterAudio.AudioListenerTransform.position);
            ...
            audio.priority =
                (int)Mathf.Lerp(HighestPriority, LowestPriority, Mathf.InverseLerp(1f, 0f, perceivedVolume));
